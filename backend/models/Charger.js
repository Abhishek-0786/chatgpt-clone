...
const Charger = sequelize.define('Charger', {
  ...
  // chargerStatus: Removed - column doesn't exist in database
  // If needed, run migration: add-charger-status.js
  // chargerStatus: {
  ...
  defaultScope: {
    attributes: {
      exclude: ['chargerStatus'] // Exclude chargerStatus as it doesn't exist in database
    }
  }
});
